...
const ServiceCard = ({ index, title, icon }) => (
  <Tilt className='xs:w-[250px] w-full'>
    <motion.div
      ...
      className='w-full custom-gradient1 p-[1px] rounded-[20px] shadow-card'
    >
      <div
        options={{
          max: 45,
        ...
        className='custom-gradient1 rounded-[20px] py-5 px-12 min-h-[280px] flex justify-evenly items-center flex-col'
      >
        <img
          src={icon}
          alt='web-development'
